...
//    }
    ...
    fun `should create credit`()
    {
        ...
        //when
        val actualCredit: Credit = this.creditService.save(fakeCredit)
    ...
    @Test fun `should not create credit when invalid day of first installment`()
    {
        // given
    ...
    private fun buildCredit(
        ...
        dayFirstInstallment: LocalDate = LocalDate.now().plusDays(2),
